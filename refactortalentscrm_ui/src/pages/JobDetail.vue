              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Title</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Department</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Department" type="text" placeholder="Enter Department" v-model="jobDetails.department"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Location</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Salary Range</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SalaryRange" type="text" placeholder="Enter SalaryRange" v-model="jobDetails.salaryRange"></input>
																		</div>
						</td>
														</tr>
